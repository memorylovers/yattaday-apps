...
# feature worktree作成スクリプト
# Usage: ./create_worktree_feature.sh <issue-number>
# Example: ./create_worktree_feature.sh 123
...
echo "========================================="
echo "✓ Feature Worktreeが正常に作成されました!"
echo "========================================="
echo ""
