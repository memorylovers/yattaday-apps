...
- [x] **[高]** servicesディレクトリの基本構造作成 ✅ 2025-06-21
  - services/firebase/, services/admob/, services/revenuecat/, services/shared_preferences/ を作成
- [x] **[高]** Firebase関連サービスの移動 ✅ 2025-06-21
  - AuthService, AnalyticsService, CrashlyticsService を実装
  - FirestoreService, FirebaseService は不要と判断し削除
  - common/firebase/firebase_providers.dart を削除
  - Firebase SDKインスタンスProviderを削除（直接.instanceを使用）
- [ ] **[中]** AdMob関連サービスの移動
...
- 2025-06-21: Firebase Service層の整理完了
  - servicesディレクトリの基本構造作成
  - Firebase関連サービスの実装（AuthService, AnalyticsService, CrashlyticsService）
  - 不要なService削除（FirestoreService, FirebaseService）
  - Firebase SDKインスタンスProviderの削除（firebaseFirestoreProvider, firebaseAnalyticsInstanceProvider, firebaseCrashlyticsInstanceProvider, firebaseAuthProvider）
