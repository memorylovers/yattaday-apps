...
class TranslationsJa extends Translations {
	...
	@override late final _TranslationsRecordItemsJa recordItems = _TranslationsRecordItemsJa._(_root);
}
...
class _TranslationsRecordItemsJa extends TranslationsRecordItemsEn {
	_TranslationsRecordItemsJa._(TranslationsJa root) : this._root = root, super.internal(root);

	final TranslationsJa _root; // ignore: unused_field

	// Translations
	@override String get title => '記録項目';
	@override String get empty => '記録項目がありません';
	@override String get searchPlaceholder => '検索';
	@override String get searchNotAvailable => '検索機能は準備中です';
	@override String get errorMessage => 'エラーが発生しました';
	@override String get retry => '再試行';
	@override String navigateToDetail({required Object title}) => '${title}の詳細画面へ遷移';
	@override String navigateToEdit({required Object title}) => '${title}の編集画面へ遷移';
	@override String get navigateToCreate => '作成画面へ遷移';
	@override String deleteConfirm({required Object title}) => '${title}の削除確認ダイアログ表示';
	@override String get edit => '編集';
	@override String get delete => '削除';
	@override String get notFound => '記録項目が見つかりません';
	@override String get deleteTitle => '記録項目を削除';
	@override String get deleteConfirmation => 'この記録項目を削除してもよろしいですか？';
	@override String get deleteSuccess => '記録項目を削除しました';
	@override String get deleteError => '削除中にエラーが発生しました';
}
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'recordItems.title': return '記録項目';
			case 'recordItems.empty': return '記録項目がありません';
			case 'recordItems.searchPlaceholder': return '検索';
			case 'recordItems.searchNotAvailable': return '検索機能は準備中です';
			case 'recordItems.errorMessage': return 'エラーが発生しました';
			case 'recordItems.retry': return '再試行';
			case 'recordItems.navigateToDetail': return ({required Object title}) => '${title}の詳細画面へ遷移';
			case 'recordItems.navigateToEdit': return ({required Object title}) => '${title}の編集画面へ遷移';
			case 'recordItems.navigateToCreate': return '作成画面へ遷移';
			case 'recordItems.deleteConfirm': return ({required Object title}) => '${title}の削除確認ダイアログ表示';
			case 'recordItems.edit': return '編集';
			case 'recordItems.delete': return '削除';
			case 'recordItems.notFound': return '記録項目が見つかりません';
			case 'recordItems.deleteTitle': return '記録項目を削除';
			case 'recordItems.deleteConfirmation': return 'この記録項目を削除してもよろしいですか？';
			case 'recordItems.deleteSuccess': return '記録項目を削除しました';
			case 'recordItems.deleteError': return '削除中にエラーが発生しました';
			default: return null;
		}
	}
}
